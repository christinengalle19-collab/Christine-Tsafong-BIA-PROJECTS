...
•	Comprendre leurs dynamiques de performance
...
•	Je suis autonome, structurée, proactive et orientée impact.
•	J’apprends vite et je m’adapte immédiatement à un nouvel environnement.
...
•	Google Colab
•	Power BI: dashboards, DAX, modèles de données
...
•	Split train/test
•	Modèle de régression optimisé
•	Cross validation
•	Insights stratégiques pour les décideurs
Impact: Un modèle capable d’orienter les décisions d’investissement et d’améliorer la compréhension des tendances du marché.

MNIST Clustering
Projet de machine learning non supervisé appliqué au dataset MNIST.
Ce que j’ai réalisé :
•	Chargement du dataset via scikit learn
•	Application de K Means
•	Visualisation des clusters
•	Silhouette Score
•	PCA & t SNE
•	Interprétation des résultats
Impact: Une segmentation claire permettant d’illustrer la puissance du clustering pour la classification et la compréhension de patterns complexes.
Compétences clés
•	Analyse de données & BI
•	Prévision et modélisation
•	Visualisation (Power BI, Python)
•	Gestion de projet
